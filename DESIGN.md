...
```css
--grad-peach:    linear-gradient(135deg, #FFF4EC 0%, #FEE7D6 100%);  /* hành động / mục đầu trong chuỗi */
--grad-mint:     linear-gradient(135deg, #ECFDF3 0%, #D1F4DD 100%);  /* tiền / thành công / toàn xanh */
--grad-sky:      linear-gradient(135deg, #EEF4FF 0%, #DCE7FF 100%);  /* thông tin / banner ngữ cảnh */
--grad-lavender: linear-gradient(135deg, #F3EEFF 0%, #E2D6FB 100%);  /* bề mặt chính / nhịp nhấn */
--grad-rose:     linear-gradient(135deg, #FFF1F4 0%, #FDDDE3 100%);  /* xã hội / chia sẻ / điểm nhấn */
--grad-pulse:    linear-gradient(90deg, #FAFAFA 0%, #F3EEFF 50%, #FAFAFA 100%); /* dải nhẹ */
```
